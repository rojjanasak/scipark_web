...
<head>
	<meta charset="utf-8">
	<title>อุทยานวิทยาศาสตร์ มหาวิทยาลัยนเรศวร</title>
	...
	<script type="text/javascript"
		src="http://weareoutman.github.io/clockpicker/dist/jquery-clockpicker.min.js"></script>
	...
	<style>
		...
		body {
			margin: 0;
			font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Kanit, "Helvetica Neue", Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";
			font-size: 1rem;
			font-weight: 400;
			line-height: 1.5;
			color: #212529;
...
<body>
	...
	<div class="body-inner">
		...
		<header id="header" class="fixed-top header" role="banner">
			<center><a class="navbar-brand navbar-bg" href="index.html"><img class="img-fluid float-middle"
						src="images/logo4.png" alt="logo"></a></center>
			<div class="container">
				<nav class="navbar navbar-expand-lg navbar-dark">
					...
					<div class="collapse navbar-collapse text-center" id="navigation">
						<ul class="navbar-nav ml-auto">
							<li class="nav-item">
								<a class="nav-link" href="index.html">หน้าแรก</a></a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="contact.html">ติดต่อเรา</a></a>
							</li>
						</ul>
					</div>
				</nav>
		...
		<div id="banner-area">
			<img src="images/banner/banner1.jpg" alt="" width="100%" />
						...
						<div class="row">
							<div class="col-md-4 col-sm-4">
								<div class="form-group">
									<label for="exampleInputPassword1">คำนำหน้าชื่อ *</label>
									<span id="building">
				...
				<div class="row">
					<div class="col-md-12 text-center">
						<ul class="footer-social unstyled">
							<li>
								<a title="Facebook"
									href="https://www.facebook.com/pages/category/Government-Organization/NU-SciPark-547002178663488/">
				...
				<div class="row">
					<div class="col-md-12 text-center">
						<div class="copyright-info">
							&copy; Copyright 2020 <span>Designed by <a
									href="https://www.mapedia.co.th/#/">mapedia.com</a></span>
						</div>
					</div>
				</div>
				<!--/ Row end -->
